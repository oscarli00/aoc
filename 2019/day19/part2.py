...
if __name__ == "__main__":
    ...
    # Left and right boundary of the beam is non-decreasing as y increases.
    # For every right boundary, treat it as the top right corner and check
    # if the bottom left corner (i.e. 99 rows down, 99 cols left from top right)
    # is in the beam.
    width = 100
    y = 2
    right = 0
