...
class Computer:
    ...
    def run_and_print(self) -> ExitCode:
        line = []
        while True:
            c = self.run()
            if c == ExitCode.HALT:
...
if __name__ == "__main__":
    ...
    # jump if not(a and b and c is true) and (d is not false) and (e is true or h is true)
    instructions = [
        # (d is not false) stored in J
        "OR D J\n",

        # (e is true or h is true) stored in T
        "NOT E T\n",
        "NOT T T\n",
        "OR H T\n",

        # (d is not false) and (e is true or h is true) stored in J
        "AND T J\n",

        # not(a and b and c is true) stored in T
        "NOT A T\n",
        "NOT T T\n",
        "AND B T\n",
        "AND C T\n",
        ...
        # finally combine T and J together
        "AND T J\n",
...
If there is a gap coming up, you must jump either 3, 2 or 1 block(s) before it
- do not jump if D is false
- do not jump if E is false and H is false
"""
